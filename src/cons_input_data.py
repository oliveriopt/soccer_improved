...
type_rating_dynamic = ["dynamic_ft_total", "dynamic_ft_home", "dynamic_ft_away", "dynamic_ft_total_g>15",
                       "dynamic_ft_total_g>25",
                       "dynamic_ft_total_g>35", "dynamic_ft_total_g>15", "dynamic_ft_total_g>25",
                       "dynamic_ft_total_g>35", "dynamic_ft_home_g>15", "dynamic_ft_home_g>25",
                       "dynamic_ft_home_g>35", "dynamic_ft_away_g>15", "dynamic_ft_away_g>25",
                       "dynamic_ft_away_g>35", "dynamic_ft_total_g<15", "dynamic_ft_total_g<25",
                       "dynamic_ft_total_g<35", "dynamic_ft_total_g<15", "dynamic_ft_total_g<25",
                       "dynamic_ft_total_g<35", "dynamic_ft_home_g<15", "dynamic_ft_home_g<25",
                       "dynamic_ft_home_g<35", "dynamic_ft_away_g<15", "dynamic_ft_away_g<25",
                       "dynamic_ft_away_g<35", "dynamic_ht_total", "dynamic_ht_home", "dynamic_ht_away",
                       "dynamic_ht_total_g>15", "dynamic_ht_total_g>25",
                       "dynamic_ht_total_g>35", "dynamic_ht_total_g>15", "dynamic_ht_total_g>25",
                       "dynamic_ht_total_g>35", "dynamic_ht_home_g>15", "dynamic_ht_home_g>25",
                       "dynamic_ht_home_g>35", "dynamic_ht_away_g>15", "dynamic_ht_away_g>25",
                       "dynamic_ht_away_g>35", "dynamic_ht_total_g<15", "dynamic_ht_total_g<25",
                       "dynamic_ht_total_g<35", "dynamic_ht_total_g<15", "dynamic_ht_total_g<25",
                       "dynamic_ht_total_g<35", "dynamic_ht_home_g<15", "dynamic_ht_home_g<25",
                       "dynamic_ht_home_g<35", "dynamic_ht_away_g<15", "dynamic_ht_away_g<25",
                       "dynamic_ht_away_g<35"]
columns_rating = ["year", "team", "type_rating", "value_rating"]
columns_points = ["year", "team", "home_away_total","type_rating", "points", "game_id", "date"]
...
odds = {"B365H": "Bet365 home win odds",
